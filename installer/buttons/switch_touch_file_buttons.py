...
press_count = {pin: 0 for pin in args.button_numbers}
...
def toggle_file_for_button(pin):
    press_count[pin] += 1
    if press_count[pin] % 2 == 1:  # Odd press count - create the file
...
# Assign the press action for each button
for button in buttons:
    button.when_pressed = lambda pin=button.pin: toggle_file_for_button(pin)
