...
SMART_OUTLET_OFF_URL1="http://192.168.9.251/rpc/Switch.Set?id=0&on=false"
SMART_OUTLET_OFF_URL2="http://192.168.9.252/rpc/Switch.Set?id=0&on=false"
SMART_OUTLET_OFF_URL3="http://192.168.9.253/rpc/Switch.Set?id=0&on=false"
